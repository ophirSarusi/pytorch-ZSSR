...
class simpleNet(nn.Module):
    def __init__(self, Y=True, loss='mse'):
        ...
        self.input = nn.Conv2d(in_channels=d_in, out_channels=128, kernel_size=3, stride=1, padding=1, bias=False)
        ...
        self.output = nn.Conv2d(in_channels=128, out_channels=d_out, kernel_size=3, stride=1, padding=1, bias=False)
